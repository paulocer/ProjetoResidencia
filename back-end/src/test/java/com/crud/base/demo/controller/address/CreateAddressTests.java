...
public class CreateAddressTests {
    ...
    public void beforeAach() throws ResourceNotFoundException, ResourceAlreadyExists {
        addressAlreadyExists = new Address("Apelido","country", "state", "city", "district", "street", 0, "44380-000");
        ...
        addressToCreate = new Address("Apelido1","country1", "state1", "city1", "district1", "street1", 1, "44380-000");
    }
    ...
    public void createWhenAlreadyExists() throws Exception {
        ...
        addressAlreadyExists.put("apelido", this.addressAlreadyExists.getApelido());
